				...
				$.ajax({
					...
					success:function(data){
						...
						if(data != "" && data != ",,"){
		                    ...
		                    htmlTable2+="<thead>";
		                        htmlTable2+="<tr height='20px'>";
		                            ...
		                            htmlTable2+="<th >ยอดเฉลี่รายได้ต่อวัน</th>";
		                        htmlTable2+="</tr>";
		                    htmlTable2+="</thead>";
		                    htmlTable2+="<tbody>";
		                ...
		                //$(".td").css({"heigth":"10px","text-align":"left"});
							...
							$("#Chart_exat_revenue_by_revenue_accumulate_table").html("<table class=\"table table-bordered\"><tbody><tr><td ><center>0 บาท</center></td><td ><center>0 %</center></td><td ><center>0 บาท</center></td></tr></tbody><thead><tr><th>รายได้สะสม</th><th>เพิ่ม/ลด จากปีที่แล้ว</th><th>ยอดเฉลี่รายได้ต่อวัน</th> </tr></thead></table>");
