		...
		$.ajax({
			...
			success:function(data){
				...
				$.ajax({
					...
					url: "../Model/Inventory/inventory_accumulate_table.jsp",
					type: "get",
					dataType: "json",
					...
					success:function(data){
		                ...
		                $("#Chart_exat_inventory_by_inventory_accumulate_table").html(htmlTable2);
							...
							$("#Chart_exat_inventory_by_inventory_accumulate_table").html("<table class=\"table table-bordered\"><tbody><tr><td colspan=\"3\"><center>ปีงบประมาณที่เลือก \"ยังไม่มีข้อมูล\"</center></td></tr></tbody><thead><tr><th>บัตรพร้อมใช้งาน</th><th>คืนบัตร/บัตรพร้อมใช้งาน</th><th>บัตรหาย</th> </tr></thead></table>");
				...
				$.ajax({
					...
					success:function(data){
						...
						if(data != ""){
							...
							option=[];
							option['themeCustom']=["#24C0F1","#49BF67","#9564E2","#F8A326","#FFD700","#F34541","#FEE074","#999999"];
