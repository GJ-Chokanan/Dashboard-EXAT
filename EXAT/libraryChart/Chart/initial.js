...
//option['tooltipTextColor']="#000000";
option['tooltipFontSize']="20px";
...
function tooltipContentEditorByCate(str, seriesIndex, pointIndex, plot) {
	...
	*/
	//alert(pointIndex);
	$("#"+idChart+">.jqplot-highlighter-tooltip").css({"background":themeCustomArray[pointIndex],"font-size":option['tooltipFontSize'],"color":option['tooltipTextColor'],"opacity":"1","z-index":"12999","padding-left":"2px","padding-right":"5px"});
...
function tooltipContentEditor(str, seriesIndex, pointIndex , plot) {
	...
	//if(option['themeCustom']!=undefined){
		...
		$("#"+idChart+">.jqplot-highlighter-tooltip").css({"background":themeCustomArray[seriesIndex],"font-size":option['tooltipFontSize'],"color":option['tooltipTextColor'],"opacity":"1","z-index":"12999","padding-left":"2px","padding-right":"5px"});
...
//	}else{
//		return plot.series[seriesIndex]["label"] + " " + addCommas(plot.data[seriesIndex][pointIndex])+ " " + addCommas(plot.data[seriesIndex][pointIndex]);	
//	}
