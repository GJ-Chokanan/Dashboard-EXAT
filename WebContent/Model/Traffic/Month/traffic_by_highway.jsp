...
<%
	th.co.exat.service.connectionJNDI jndi = new th.co.exat.service.connectionJNDI();
		...
		String query=" Select Replace(Buddhist_Short_Date,Substr(Buddhist_Short_Date,-3,3),'') ,Highway_Name ,Round(No_Of_Traffic_This_Year/1000000) As No_Of_Traffic_This_Year from( "+
