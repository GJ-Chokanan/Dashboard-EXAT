	...
	$("a[href='#tabs-2']").click(function(){
		...
		$.ajax({
			...
			easypass_accumulate_table($("#exatparamYearList").val());
				...
				easypass_by_data_easypass(YearSubPie);
				...
				easypass_by_data_easypass_table(YearSubPie);
				...
				$.ajax({
					...
					success:function(data){
						...
						if(data != ""){
							//alert("11"+data);
							$("#Chart_exat_easypass_by_member_type").css({"margin-top":"16px"});
							option=[];
					...
					success:function(data){
	                    ...
	                    $('#Chart_exat_easypass_by_sales_easypass_accumulate_year').bind('jqplotDataClick',                
	                             ...
	                             if((i%2)!=0){
	                           	...
	                           	//alert(cateparamYear);
	                           	if(parseInt(cateparamYear) >= parseInt(2558)){
	                           		...
	                           		$('.YearSubPie').html(cateparamYear).val();
	                           	}
