	            		...
	            		
	              {
	                ...
	                seriesDefaults: {
	                  ...
	                  rendererOptions: {
	                    ...
	                    padding:option['padding'],pieWidth : 500
	                ...
	                legend: { show:true, location: option['location'], placement :option['placement'],rendererOptions: {
	                       numberRows: option['numberRows'],diameter: 10
	                }},
	                gridPadding: {top:option['gridPaddingTop'], bottom:option['gridPaddingBottom'], left:option['gridPaddingLeft'], right:option['gridPaddingRight']}
	              }
